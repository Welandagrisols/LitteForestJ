          ...
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-medium text-green-800 truncate">Total Plants</p>
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-green-900">{loading ? "..." : stats.totalPlants}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mobile-card bg-purple-50 border-purple-200">
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-medium text-purple-800 truncate">Categories</p>
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-purple-900">{loading ? "..." : stats.categories.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mobile-card bg-blue-50 border-blue-200">
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-medium text-blue-800 truncate">Healthy Plants</p>
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-blue-900">{loading ? "..." : stats.healthyPlants}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mobile-card bg-orange-50 border-orange-200">
          <CardContent className="p-3 sm:p-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-medium text-orange-800 truncate">Avg Value</p>
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-orange-900">
